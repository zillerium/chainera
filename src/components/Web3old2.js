...
const Web3 = () => {
  ...
  const handleBoxClick = (id) => {
    ...
    <div className="container mt-3">
      <div className="row">
        <div className="col">
		          <h1 className="text-center">Web3 Component</h1>
      ...
      <div className="row">
          ...
          <p>This is a component that demonstrates the use of React and Bootstrap to create a responsive layout of boxes.</p>
        </div>
      </div>
      {rows.map((boxes, index) => (
        ...
        <div className="col text-center">
          <p>Thank you for viewing this component!</p>
        </div>
      </div>
    </div>
  );
